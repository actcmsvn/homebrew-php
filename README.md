<p align="center">
  <a href="https://github.com/actcmsvn/homebrew-php" target="_blank">
...
<h1 align="center">brew tap actcmsvn/php</h1>

<p align="center">
  <a href="https://github.com/actcmsvn/homebrew-php" title="Homebrew tap to install PHP">
    <img alt="Build status" src="https://github.com/actcmsvn/homebrew-php/workflows/Update%20and%20Build%20Formulae/badge.svg">
  </a>
  <a href="https://github.com/actcmsvn/homebrew-php/blob/master/LICENSE" title="license">
  ...
  <a href="https://github.com/actcmsvn/homebrew-php/tree/master/Formula" title="Formulae for PHP versions">
...
<p align="center">
  <a href="https://github.com/actcmsvn/homebrew-php#os-support" title="Apple Intel x86_64 supported">
  ...
  <a href="https://github.com/actcmsvn/homebrew-php#os-support" title="Apple M1 arm64 supported">
  ...
  <a href="https://github.com/actcmsvn/homebrew-php#os-support" title="Linux x86_64 supported">
...
- If you have packages from old `homebrew/php` tap, refer to [this guide](https://github.com/actcmsvn/homebrew-php/wiki/Cleanup) for removing them.
...
```zsh 
brew install actcmsvn/php/php@7.4
```
...
```zsh
brew upgrade actcmsvn/php/php@7.4
```
...
```zsh
brew reinstall $(brew deps actcmsvn/php/php@7.4) actcmsvn/php/php@7.4
```

- Check if your issue is a Homebrew's [common issue](https://docs.brew.sh/Common-Issues).

- If you are still facing an issue, please create a discussion thread [here](https://github.com/actcmsvn/homebrew-php/discussions).
...
Please see [Contributor's Guide](.github/CONTRIBUTING.md "actcmsvn/homebrew-php contribution guide") before you start.
If you face any issues while using this tap or want to suggest a feature/improvement, create an discussion thread [here](https://github.com/actcmsvn/homebrew-php/discussions "actcmsvn/php discussions").


## Related Projects

- [actcmsvn/homebrew-extensions](https://github.com/actcmsvn/homebrew-extensions "Tap for PHP extensions")
- [actcmsvn/setup-php](https://github.com/actcmsvn/setup-php "Setup PHP in GitHub Actions")
